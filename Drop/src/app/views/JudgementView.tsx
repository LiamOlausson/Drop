...
export const JudgementView: React.FC<JudgementViewProps> = ({ gameState, executeAction }) => {
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '30px', alignItems: 'center', width: '100%', maxWidth: '1200px' }}>
            ...
            <div style={{ display: 'flex', gap: '20px', marginTop: '20px', padding: '20px', backgroundColor: '#1e272e', borderRadius: '12px', border: '2px solid #333' }}>
                <button
                    onClick={() => executeAction('StartHand', { anteAmount: 10 })}
                    style={{ padding: '15px 30px', fontSize: '18px', backgroundColor: '#3c40c6', color: '#FFF', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: 'bold' }}
                >
                    Start Next Hand
                </button>
                ...
                <button
                    ...
                    style={{ padding: '15px 30px', fontSize: '18px', backgroundColor: '#ff7675', color: '#111', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: 'bold' }}
                >
                    Return to Lobby
                </button>
            </div>

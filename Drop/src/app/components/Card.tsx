    ...
    if (hidden || !card) {
        return (
            <div style={{
                ...
                background: `
          radial-gradient(circle at 50% 50%, #2e2318 0%, #1a1410 100%)
        `,
    ...
    return (
        <div style={{
            ...
            boxShadow: card.isRevealed
                ? `0 4px 16px rgba(0,0,0,0.6), 0 0 12px ${cfg.glow}`
        ...
        <span style={{
            ...
            fontSize: sz.font, color: '#1a1410', lineHeight: 1,
                ...
                <span style={{ fontSize: sz.font - 2, color: cfg.color, fontFamily: 'IM Fell English, serif', fontStyle: 'italic' }}>
          {card.rank}
        </span>
            </div>
